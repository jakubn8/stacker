      ...
      <div className="p-6 md:p-8">
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="border-b border-zinc-800 pb-6">
            <h1 className="text-3xl font-bold text-white">Billing Portal</h1>
          ...
          {!billingStatus?.user?.paymentMethodConnected ? (
            ...
            <div className="bg-gradient-to-br from-green-500/10 via-emerald-500/10 to-teal-500/10 border border-green-500/20 rounded-2xl p-8">
              <div className="flex items-start gap-6">
                ...
                <div className="flex-1">
                  <h2 className="text-2xl font-bold text-white mb-2">Connect a Payment Method</h2>
            ...
            <>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-5">
                  <p className="text-zinc-400 text-sm mb-1">Current Bill</p>
              ...
              <div className="flex flex-wrap items-center gap-3">
                <button
                  onClick={handleUpdatePaymentMethod}
                  disabled={connectingPayment}
                  className="inline-flex items-center gap-2 px-4 py-2 bg-zinc-800 hover:bg-zinc-700 border border-zinc-700 rounded-lg text-zinc-300 hover:text-white font-medium transition-colors cursor-pointer disabled:cursor-not-allowed"
                >
                  {connectingPayment ? "Loading..." : "Update Payment Method"}
                </button>
              </div>
              ...
              <div className="bg-zinc-900 border border-zinc-800 rounded-xl overflow-hidden">
                <div className="p-5 border-b border-zinc-800">
                  ...
                  <p className="text-zinc-500 text-sm">Sales that will be included in your next invoice</p>
                </div>
                  ...
                  <div className="divide-y divide-zinc-800">
                    {billingStatus.recentInvoices.map((i) => (
                      <div key={i.id} className="flex items-center justify-between p-4 hover:bg-zinc-800/30">
                        ...
                        <div className="flex items-center gap-3">
                          <p className="text-white font-medium">${i.totalFee.toFixed(2)}</p>
          ...
          <div className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-6">
            <h3 className="text-white font-semibold mb-3">How Stacker Billing Works</h3>
            <ul className="space-y-2 text-zinc-400 text-sm">
              <li className="flex items-start gap-2">
                <svg className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span>We charge <strong className="text-white">5%</strong> on successful upsells only - we only make money when you do</span>
              </li>
              <li className="flex items-start gap-2">
                <svg className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span>Billing happens automatically every <strong className="text-white">7 days</strong></span>
              </li>
              <li className="flex items-start gap-2">
                <svg className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span>Minimum charge is <strong className="text-white">$0.50</strong> - smaller amounts roll over</span>
              </li>
              <li className="flex items-start gap-2">
                <svg className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
